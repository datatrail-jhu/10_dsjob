...
![Cover Letter](images/02_coverletter/02_dsjob_coverletter-3.png)
...
![Contact Information](images/02_coverletter/02_dsjob_coverletter-4.png)
...
![Use the hiring manager's name](images/02_coverletter/02_dsjob_coverletter-5.png)
...
![Content of letter](images/02_coverletter/02_dsjob_coverletter-6.png)

Finally, close your letter and include your name on the line after your closing (i.e. "Sincerely,").

![Close your letter and include your name](images/02_coverletter/02_dsjob_coverletter-7.png)
...
![Intro](images/02_coverletter/02_dsjob_coverletter-8.png)
...
![Body](images/02_coverletter/02_dsjob_coverletter-9.png)
...
![Closing](images/02_coverletter/02_dsjob_coverletter-10.png)
...
![Call-To-Action](images/02_coverletter/02_dsjob_coverletter-11.png)
...
{choose-answers: 4}
? Which of the following is **not** a word or phrase to avoid using in a cover letter? (Note: Read the information in [this link](https://www.glassdoor.com/blog/cover-letter-words/) before answering this question.)
...
o) "dynamic"
o) "significant"
o) "really, truly deeply"
o) "self-starter"
o) "detail-oriented"
o) "forward-thinker"

{choose-answers: 4}
? What is a goal of a cover letter?

C) demonstrate using specifics why you are the right person for the job 
C) convey your personality while still being professional
o) explain your entire work history
o) state in general terms why you'd be a good fit for the job
o) to demand an in-person interview or follow-up call
o) provide the hiring manager with all the necessary details they'd need
o) explain everyone you've ever worked with before
o) to name drop every important person in the industry, whether or not you know them

? TRUE or FALSE: It's best to demonstrate that you're an outgoing and bubbly person in a cover letter, regardless of whether or not that's true.

a) TRUE
B) FALSE

? TRUE or FALSE: My cover letter is the place in the application where I should use specific examples from my experience and tell a story or two to demonstrate why I'm a good fit for the position.

A) TRUE
b) FALSE

? TRUE or FALSE: If the job description requires a college degree for the job and I do not have one, I should state that I do anyway in my cover letter.
